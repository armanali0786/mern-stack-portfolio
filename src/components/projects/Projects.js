  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 xl:gap-14">
        <a href='https://github.com/armanali0786/social-media-app'>
        <ProjectsCard
        ...
        />
         ...
         <a href='https://github.com/armanali0786/Dashboard-prime-react'>
         <ProjectsCard
        ...
        <a href='https://github.com/armanali0786/Rental-Management-System' > 
        <ProjectsCard
